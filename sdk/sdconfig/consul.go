...
// Consul is the configuration for Consul service discovery.
type Consul struct {
...
// DefaultConsul is the default Consul SD configuration.
...
func (c *Consul) UnmarshalYAML(unmarshal func(interface{}) error) error {
	*c = DefaultConsul
	type plain Consul
