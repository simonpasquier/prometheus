...
import "github.com/simonpasquier/prometheus/pkg/textparse"
...
//
//     go-fuzz-build -func FuzzParseMetric -o FuzzParseMetric.zip github.com/simonpasquier/prometheus/promql
//
